<?php use 
    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST" && isset($_POST['verComodidade'])){
        $idComodidade = $_POST['verComodidade'];
    }
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <link rel="stylesheet" href="./assets/CSS/comodidades.css">
...
<body>
    <?php
        $query = "SELECT * FROM comodidades WHERE id = '$idComodidade';";
